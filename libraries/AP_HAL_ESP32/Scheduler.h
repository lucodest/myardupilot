...
public:
    ...
    static const int MAIN_PRIO    = 21; //	cpu0: we want scheduler running at full tilt.
    static const int I2C_PRIORITY = 5;  //      if your primary imu is i2c, this should be above the spi value, i2c is not preferred.
    static const int TIMER_PRIO   = 20; //dont make 24. a low priority mere might cause wifi thruput to suffer
    static const int RCIN_PRIO    = 5;
    static const int RCOUT_PRIO   = 10;
    static const int WIFI_PRIO1   = 19; //cpu1:
    static const int WIFI_PRIO2   = 12; //cpu1:
    static const int UART_PRIO    = 20; //dont make 24, scheduler suffers a bit. cpu1: a low priority mere might cause wifi thruput to suffer, as wifi gets passed its data frim the uart subsustem in _writebuf/_readbuf
