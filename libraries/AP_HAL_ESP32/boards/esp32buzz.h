...
#define DEFAULT_SERIAL2_BAUD 1000
...
// IMU probing:
//#define HAL_INS_PROBE_LIST PROBE_IMU_SPI(BMI160, "bmi160", ROTATION_ROLL_180_YAW_90)
// MAG/COMPASS probing:
...
#define HAL_ESP32_UART_DEVICES \
  {.port=UART_NUM_0, .rx=GPIO_NUM_3, .tx=GPIO_NUM_1 }, {.port=UART_NUM_1, .rx=GPIO_NUM_14, .tx=GPIO_NUM_15 }
